...
int main() {
string looping_var {"y"};
while ( looping_var =="y"|| looping_var== "Y") {
 cout << "********************** Welcome to Calculator De La Monde! ***********************\n" << endl;
   
   cout << "This calculator provides the following operations,S'il Vous platait(Please) Choose one: \n" ;
   cout << " 1) Division\n 2) Multiplication\n 3) Addition\n 4) Substraction\n";
   cout << " 5) sin()\n 6) cos()\n 7) tan()\n 8) exp()\n====================\n";
  ...
  double result {};
   ...
   {double num1 {} , num2 {} ;
    ...
    cout << "Enter the first number: " ;
     ...
     cin >> num2;
    result = num1 + num2;
    cout << "\nAddition of " << num1 << " and " << num2 << " gives " << result;}
     ...
     cin >> num2;
    result = num1 - num2;
    cout << "\nSubstraction of " << num1 << " and " << num2 << " gives " << result;}
     ...
     cin >> num2;
    result = num1 * num2;
    cout << "\nMultiplication of " << num1 << " and " << num2 << " gives " << result;}
     ...
     cin >> num2;
    result = num1 / num2;
    cout << "\nDivision of " << num1 << " and " << num2 << " gives " << result;}
   }
